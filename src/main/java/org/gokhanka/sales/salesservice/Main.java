...
public class Main {
    ...
    public static final String BASE_URI = "http://localhost:8080/sales/";
    ...
    public static HttpServer startServer() {
        ...
        // in org.gokhanka.sales.salesservice package
        final ResourceConfig rc = new ResourceConfig().packages("org.gokhanka.sales.salesservice");
